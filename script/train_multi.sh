...
network_weights="../../result/${bench_mark}/${obj_name}/${sub_folder}/${folder_name}/models/epoch-000012.safetensors"
...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config \
 ...
 --start_epoch 12 --max_train_epochs 30 \
