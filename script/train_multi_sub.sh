...
sub_folder="sub_3_background_masked_sample_anomal_sample_up_32"
folder_name="attn_loss_normalized_map_loss_not_dist_loss"
output_dir="../../result/${bench_mark}/${obj_name}/${sub_folder}/${folder_name}"
network_weights="../../result/${bench_mark}/${obj_name}/${sub_folder}/${folder_name}/epoch-000004.safetensors"
